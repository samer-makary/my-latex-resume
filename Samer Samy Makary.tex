...
\cfoot{\textit{\small Page \thepage \hspace{1pt} of 2}}
...
%-----------Experience Areas & Tools-----------------
\section{Experience Areas \& Tools\footnotemark}
  \footnotetext{Technologies are listed in decreasing order of experience.}

  \resumeSubHeadingListStart
    \resumeSubItem{Advanced Computing}{Distributed Cloud Computing -- Global Geo-separated Data Stores -- Distributed Caching -- Serverless Architectures}
    \resumeSubItem{Data Protection and Cybersecurity}{DDOS Protection, WAF, and API Authentication Protocols -- Cryptology and Data Privacy}
	\resumeSubItem{Tech Business Domains}{E-Commerce and Advertising -- Music and Live Broadcast -- Digital Data Transformation -- Location-based Services -- Augment Reality}
